...
import numpy as np
from svl_script.apollo_configs import get_modules_for_id
...
def initialize_dv_and_ego(sim, map, model_id, start, destination, BRIDGE_HOST, BRIDGE_PORT, events_path):
    ...
    def on_collision(agent1, agent2, contact):
        ...
        agent1_info = [agent1.transform.position.x, agent1.transform.position.y, agent1.transform.position.z, agent1.state.velocity.x, agent1.state.velocity.y, agent1.state.velocity.z]
        ...
        if not agent2:
            ...
            agent2_info = [
            agent2.transform.position.x, agent2.transform.position.y, agent2.transform.position.z, agent2.state.velocity.x, agent2.state.velocity.y, agent2.state.velocity.z]
        ...
        data_row = ['collision', agent2_name, agent2_uid] + agent1_info + agent2_info + contact_loc
